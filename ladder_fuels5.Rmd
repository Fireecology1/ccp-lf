...
with the Immature treatment is the base case. Note that a post-hoc Tukey
...
Nonetheless, we used this model to identify the most likely ISI crowning
thresholds between treatments (Figure XX). This produced the three
logistic curves shown in Figure X. By solving for p=0.5 (50%
probability), we calculated the three crown fire transition thresholds
as follows:
...
Crowning thresholds, as shown in the figure, were #inline code thresh.

We then looked at what surface ROS values would tend to occur (in the
absence of crowning) under conifer stands.
